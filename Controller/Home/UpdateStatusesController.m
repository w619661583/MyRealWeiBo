...
- (void)loadView
{
    ...
    UIImageView *cancelImageView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"4.jpg"]] autorelease];
    ...
    [cancelButton setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    [cancelButton addTarget:self
                     action:@selector(cancelBarButtonAction:)
           forControlEvents:UIControlEventTouchUpInside];
    [loadTextView addSubview:cancelButton];
    
    UIImageView *updateImageView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"4.jpg"]] autorelease];
    ...
    [updateButton setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    ...
    UIImage *stretchableImage = [[UIImage imageNamed:@"4.jpg"] stretchableImageWithLeftCapWidth:12 topCapHeight:12];
    ...
    self.inputTextView.font = [UIFont fontWithName:@"Helvetica" size:14];
    ...
    numLabel.text = @"140";
    numLabel.font = [UIFont fontWithName:@"Helvetica" size:14];
    ...
    [toolButton1 setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    ...
    [toolButton2 setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    ...
    [toolButton3 setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    ...
    [toolButton4 setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    ...
    [toolButton5 setBackgroundImage:[UIImage imageNamed:@"4.jpg"] forState:UIControlStateNormal];
    ...
    for (int i = 0; i < 4; ++i)
    {
        ...
        seperatorLineImageView.image = [UIImage imageNamed:@"4.jpg"];
...
//{
//    WeiboManager *weiboM = [WeiboManager new];
//    
